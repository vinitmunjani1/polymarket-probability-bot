...
class Settings:
    ...
    min_signal_price: float = 0.84
    trade_trigger_mode: str = "edge_or_signal"
    ...
    def load(cls) -> "Settings":
        ...
        return cls(
            ...
            min_signal_price=float(os.getenv("MIN_SIGNAL_PRICE", "0.84")),
            trade_trigger_mode=os.getenv("TRADE_TRIGGER_MODE", "edge_or_signal").strip().lower(),
