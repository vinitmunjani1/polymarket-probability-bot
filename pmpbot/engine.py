...
class BotEngine:
    ...
    async def evaluate_asset(self, asset: str) -> None:
        ...
        log = {
            ...
            "up_bid": None if not up_book else up_book.bid,
            "up_ask": None if not up_book else up_book.ask,
            "down_bid": None if not down_book else down_book.bid,
            "down_ask": None if not down_book else down_book.ask,
